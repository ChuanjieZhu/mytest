...
IMPLEMENT_LOG_FUNC(Logger,Debug,LDEBUG)
IMPLEMENT_LOG_FUNC(Logger,Info,LINFO)
IMPLEMENT_LOG_FUNC(Logger,Warn,LWARN)
IMPLEMENT_LOG_FUNC(Logger,Error,LERROR)
IMPLEMENT_LOG_FUNC(Logger,Fatal,LFATAL)
