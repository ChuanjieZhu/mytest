...
#define jtTTS_SPEED_MID			8000	// normal voice speed (default)
...
typedef enum 
{
	...
	jtTTS_PARAM_WORDSEGMENT_CALLBACK,	// word segment callback entry
	jtTTS_PARAM_SPEEDDOUBLE,			//语速调节范围加大	
	jtTTS_PARAM_SHORTSILENCE,			//缩短静音
