...
struct DhclientOptions
{
    ...
    u_int8_t *hostname_buff;             /* Hostname buffer*/
    ...
    u_int32_t unicast_ip_address;
    u_int8_t unicast_flag;
...
int set_option50(char *ip_str);   /* Sets the offer ip */
int set_option54(char *ip_str);    /* Sets the server ip */
int set_serv_id_opt50();	/* Sets the server_ip and option50 ip */

int parse_dhcp_offer();
int parse_dhcp_ack(DHCP_RESULT *result, char *if_name);
